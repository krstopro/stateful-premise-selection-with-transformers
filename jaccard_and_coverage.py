...
total_jaccard = sum([len(deps_predicted[thm] & deps_true[thm]) for thm in deps_predicted]) / sum([len(deps_predicted[thm] | deps_true[thm]) for thm in deps_true])
total_coverage = sum([len(deps_predicted[thm] & deps_true[thm]) for thm in deps_predicted]) / sum([len(deps_true[thm]) for thm in deps_true])
